    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="cadastrar_transportadora.php?acao=alterar&registro=<?php echo $linha['shipper_id'] ?>" class="green">
                    ...
                    <a href='excluir_transportadora.php?acao=deletar&registro=<?php echo $linha['shipper_id']?>' class="red">
            ...
            <?php 
                ...
                if(isset($_GET['acao']) && $_GET['acao'] == 'deletar') {
                    DeletarRegistro($_GET['registro'], "shippers", "shipper_id");
                }
            ?>
        </tbody>
    </table>
